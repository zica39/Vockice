...
function pocni_igru() {
    ...
    document.onkeydown = function(e) {
        ...
        if (key == 'b')
            if (ulozi_dugme.innerHTML == 'Replace costs 1x Stake' && !ulozi_dugme.classList.contains('invisible')) ulozi_dugme.click();
...
function ispuni_primarni_slot() {
    primarni_slot.forEach((e, i, arr) => {
        var br = daj_nasmumirni_broj();
        if (br == 9) br = daj_nasmumirni_broj();
        primarni_slot[i] = br;
